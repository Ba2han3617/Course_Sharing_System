...
namespace CourseNoteSharingSystem.Repositories
{
    ...
    public class NoteRepository : Repository<Note>, INoteRepository
    {
        ...
        public async Task<List<Note>> GetByUserAsync(string userId)
            => await _db.Notes
                .Include(n => n.Course)
                .Include(n => n.Likes)
                .Include(n => n.Ratings)
        ...
        public async Task<List<Note>> GetLikedByUserAsync(string userId)
            => await _db.Likes
        ...
        public async Task<List<Note>> GetFavoritedByUserAsync(string userId)
            => await _db.Favorites
    ...
    public class CourseRepository : Repository<Course>, ICourseRepository
    {
        ...
        public async Task<List<Course>> SearchAsync(string? query, string? department)
        {
            ...
            if (!string.IsNullOrWhiteSpace(query))
                q = q.Where(c => c.CourseName.ToLower().Contains(query.ToLower()) || c.Code.ToLower().Contains(query.ToLower()));
            if (!string.IsNullOrWhiteSpace(department))
    ...
    public class LikeRepository : Repository<Like>, ILikeRepository
    {
        ...
        public async Task<Like?> GetUserLikeAsync(string userId, int noteId)
    ...
    public class RatingRepository : Repository<Rating>, IRatingRepository
    {
        ...
        public async Task<Rating?> GetUserRatingAsync(string userId, int noteId)
    ...
    public class FavoriteRepository : Repository<Favorite>, IFavoriteRepository
    {
        ...
        public async Task<Favorite?> GetUserFavoriteAsync(string userId, int noteId)
